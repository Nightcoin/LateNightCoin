...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(76800000000000000);
...
const char     CRYPTONOTE_NAME[]                             = "LateNightCoin";
...
const int      P2P_DEFAULT_PORT                              = 32330;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 32331;
